...
hdfs dfs -put $new1 /user/w205/hospital_compare/hospitals
hdfs dfs -put $new2 /user/w205/hospital_compare/effective_care
hdfs dfs -put $new3 /user/w205/hospital_compare/readmissions
hdfs dfs -put $new4 /user/w205/hospital_compare/measures
hdfs dfs -put $new5 /user/w205/hospital_compare/survey_responses
